...
htmlhelp_basename = "spanclientdoc"
...
latex_documents = [
    (master_doc, "spanclient.tex", "spanclient Documentation", "Billy PeAKE", "manual")
]
...
man_pages = [(master_doc, "spanclient", "spanclient Documentation", 1)]
